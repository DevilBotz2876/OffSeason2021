...
public class PhysicsSim {
     ...
     */
    public void addTalonSRX(WPI_TalonSRX talon, final double accelToFullTime, final double fullVel) {
     ...
     */
    public void addTalonSRX(WPI_TalonSRX talon, final double accelToFullTime, final double fullVel, final boolean sensorPhase) {
        if (talon != null) {
